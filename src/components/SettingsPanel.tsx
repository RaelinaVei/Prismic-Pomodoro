...
import { X, Sun, Moon, Palette, Upload, Trash2, Image } from "lucide-react";
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 bottom-4 sm:inset-auto sm:right-8 sm:bottom-8 sm:w-[420px] z-50 rounded-2xl p-6 max-h-[85vh] overflow-y-auto bg-card border border-border shadow-2xl"
          >
                ...
                {themes.map((t) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-1">
                      <span className="text-[9px] font-body text-white leading-tight">{t.name}</span>
                    </div>
                  </button>
                ))}
              </div>
